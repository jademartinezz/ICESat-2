...
public data class SelectOnMapFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): SelectOnMapFragmentArgs {
      bundle.setClassLoader(SelectOnMapFragmentArgs::class.java.classLoader)
      val __lat : Float
      ...
      return SelectOnMapFragmentArgs(__dateObjectTime, __lat, __long, __title)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): SelectOnMapFragmentArgs {
      val __lat : Float?
