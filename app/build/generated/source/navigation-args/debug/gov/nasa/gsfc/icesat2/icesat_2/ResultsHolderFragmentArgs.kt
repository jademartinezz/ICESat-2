...
public data class ResultsHolderFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ResultsHolderFragmentArgs {
      bundle.setClassLoader(ResultsHolderFragmentArgs::class.java.classLoader)
      val __lat : Float
      ...
      return ResultsHolderFragmentArgs(__dateObjectTime, __lat, __long, __title)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ResultsHolderFragmentArgs {
      val __lat : Float?
