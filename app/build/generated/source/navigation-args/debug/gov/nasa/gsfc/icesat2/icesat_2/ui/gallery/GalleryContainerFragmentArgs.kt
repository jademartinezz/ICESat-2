...
public data class GalleryContainerFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): GalleryContainerFragmentArgs {
      bundle.setClassLoader(GalleryContainerFragmentArgs::class.java.classLoader)
      val __index : Int
      ...
      return GalleryContainerFragmentArgs(__index)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        GalleryContainerFragmentArgs {
      val __index : Int?
