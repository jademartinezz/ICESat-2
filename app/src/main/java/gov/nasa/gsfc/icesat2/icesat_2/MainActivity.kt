...
class MainActivity : AppCompatActivity(), ISearchFragmentCallback, IDownloadDataErrorCallback, LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "pre setContentView breakpoint")
        ...
        Log.d(TAG, "pre navController - breakpoint")

        // configure the bottom nav bar
        navController = findNavController(R.id.nav_host_fragment)
        Log.d(TAG, "navController - breakpoint")
        ...
        Log.d(TAG, "navController - breakpoint 2")
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            ...
            Log.d(
                TAG,
                "searchFrag destination is ${searchFragmentDestination?.label} \n previous destination is ${previousDestination?.label}"
            )
        }
        Log.d(TAG, "navController - breakpoint 4")

        navHostFragment = supportFragmentManager.findFragmentById(R.id.nav_host_fragment)
        Log.d(TAG, "navController - breakpoint 5")

        mainViewModel = ViewModelProvider(this)[MainViewModel::class.java]
        Log.d(TAG, "navController - breakpoint 6")
    ...
    override fun searchButtonPressed(lat: Double, long: Double, radius: Double, calledFromSelectOnMap: Boolean, time: Long,
        ...
        Log.d(TAG, "searchButtonPressed - MainActivity")
    ...
    override fun addErrorToSet(searchError: SearchError) {
        Log.d(TAG, "addErrorToSet - MainActivity")
    ...
    private fun isNetworkConnected(): Boolean {
        Log.d(TAG, "isNetworkConnected - MainActivity")
    ...
    private fun grantAccessSnackbar() {
        Log.d(TAG, "grantAccessSnackbar - MainActivity")
    ...
    override fun selectOnMapButtonPressed() {
        Log.d(TAG, "selectOnMapButtonPressed - MainActivity")
        if (isNetworkConnected()) {
    ...
    private fun showMap(navigationActionID: Int) {
        Log.d(TAG, "showMap - MainActivity")
    ...
    private fun launchMapNoAnimation() {
        Log.d(TAG, "launchMapNoAnimation - MainActivity")
    ...
    fun showDialogOnMainThread(title: Int, message: Int, buttonMessage: Int) {
        Log.d(TAG, "showDialogOnMainThread - MainActivity")
        GlobalScope.launch(Dispatchers.Main) {
    ...
    private fun showDialog(title: Int, message: Int, buttonMessage: Int) {
        Log.d(TAG, "showDialog - MainActivity")
    ...
    override fun trackButtonPressed() {
        Log.d(TAG, "trackButtonPressed - MainActivity")
        if (!isNetworkConnected()) {
            showDialog(R.string.noNetworkTitle, R.string.noNetworkDescription, R.string.ok)
            return
        }
